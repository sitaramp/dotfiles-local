...
return {
  ...
  default_prog                               = default_prog,
	...
	-- ALT Enter  ToggleFullScreen
        ...
        { key = "4", mods = "CTRL|M",       action=wezterm.action{ActivateTab=3}},
        { key = "5", mods = "CTRL|M",       action=wezterm.action{ActivateTab=4}},
        { key = "6", mods = "CTRL|M",       action=wezterm.action{ActivateTab=5}},
        { key = "7", mods = "CTRL|M",       action=wezterm.action{ActivateTab=6}},
        { key = "8", mods = "CTRL|M",       action=wezterm.action{ActivateTab=7}},
        { key = "9", mods = "CTRL|M",       action=wezterm.action{ActivateTab=-1}},
        { key = "0", mods = "CTRL|M",       action="ShowTabNavigator"},
        { key = "`", mods = "CTRL|M",       action="ActivateLastTab"},
